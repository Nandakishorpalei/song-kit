...
function makesound(key){
  switch (key){
    ...
    case "E":
      ...
      var audio3=new Audio("sounds/Ek_Din_Teri_Raahon.mp3");
      audio3.play();
    break;
    ...
    case "H":
      ...
      var audio4=new Audio("sounds/Hale_Dil.mp3")
      audio4.play();
    break;
...
// key section
    ...
    case "e":
      ...
      var audio10=new Audio("sounds/Ek_Din_Teri_Raahon.mp3");
      audio10.play();
    break;
    ...
    case "h":
      ...
      var audio11=new Audio("sounds/Hale_Dil.mp3")
      audio11.play();
    break;
